...
const Page3 = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center relative z-20">
        ...
        <div className="line h-0.5 w-2/3 top-[40%] bg-gray-700 absolute"></div>
        <div className="line h-0.5 w-5/6 top-[55%] bg-gray-700 absolute"></div>
        <div className="line h-0.5 w-full top-[71%] bg-gray-700 absolute"></div>
